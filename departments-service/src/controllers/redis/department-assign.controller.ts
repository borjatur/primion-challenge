...
export class DepartmentAssignController {
  ...
  async createDepartmentAssign(payload: DepartmentAssignRequest) {
    const result = await this.departmentAssignService.createDepartmentAssign(
      payload,
    );
  ...
  async editDepartmentAssign(payload: DepartmentAssignRequest) {
    const result = await this.departmentAssignService.editDepartmentAssign(
      payload,
    );
  ...
  async deleteDepartmentAssign(payload: DepartmentAssignRequest) {
    const result = await this.departmentAssignService.deleteDepartmentAssign(
      payload,
    );
